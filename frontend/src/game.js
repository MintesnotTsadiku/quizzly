...
export const SHAPES = [
  { id: '1', name: 'triangle', fill: 'bg-red-500', hover: 'hover:bg-red-600', path: 'M12 3 L22 20 L2 20 Z' },
  { id: '2', name: 'diamond', fill: 'bg-blue-500', hover: 'hover:bg-blue-600', path: 'M12 2 L22 12 L12 22 L2 12 Z' },
  { id: '3', name: 'circle', fill: 'bg-amber-500', hover: 'hover:bg-amber-600', path: 'M12 2 A10 10 0 1 1 11.99 2 Z' },
  { id: '4', name: 'square', fill: 'bg-green-600', hover: 'hover:bg-green-700', path: 'M3 3 H21 V21 H3 Z' },
]

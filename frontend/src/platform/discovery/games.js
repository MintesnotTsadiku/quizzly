		...
		demos: [
			{
				...
				title: "Bible Composed Challenge",
				blurb: "Fifteen two-part questions on people, places, and teachings across Scripture.",
				audience: "Church / Bible",
			},
			{
				demo_key: "quiz-family-general",
				title: "General Knowledge Composed",
				blurb: "Fifteen two-part questions on world facts, science, geography, and culture.",
				audience: "General Knowledge",
			},
			{
				demo_key: "quiz-big-room",
				title: "Football Composed Cup",
				blurb: "Fifteen two-part football questions: World Cup, clubs, Africa, and the laws of the game.",
				audience: "Sports / Football",
				video: "/assets/quizzly/videos/gatherplay/quiz-overview.mp4",
				poster: "/assets/quizzly/videos/gatherplay/quiz-overview-poster.jpg",
			},
			{
				demo_key: "quiz-funny",
				title: "Twenty Laughs Live",
				blurb: "Twenty clean joke questions. Wrong answers are part of the fun.",
				audience: "Funny / Warm-up",
			},
			{
				demo_key: "quiz-amharic-riddles-1",
				title: "እንቆቅልሽ · ክፍል 1",
				blurb: "Fifteen house riddles, including egg, maize, and a couple of funny ones.",
				audience: "እንቆቅልሽ",
			},
			{
				demo_key: "quiz-amharic-riddles-2",
				title: "እንቆቅልሽ · ክፍል 2",
				blurb: "Fifteen riddles on nature, coffee and injera, plus TV and radio jokes.",
				audience: "እንቆቅልሽ",
			},
			{
				demo_key: "quiz-amharic-riddles-3",
				title: "እንቆቅልሽ · ክፍል 3",
				blurb: "Fifteen modern and funny riddles: phone, photo, and the riddle itself.",
				audience: "እንቆቅልሽ",
			},
		],
	},

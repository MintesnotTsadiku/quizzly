...
const GAME_VISUALS = {
	...
	"grid-conquest": {
		hero: `${ASSET_ROOT}/grid-conquest/how-to.webp`,
		example: `${ASSET_ROOT}/grid-conquest/example-round.webp`,
		exampleAlt: "Worked Grid Conquest round: Hana identifies Top right as the move that completes the X row and earns 1,000 points.",
		summary: "Everyone studies the same connection board and privately chooses the strongest move before the room-wide reveal.",
		steps: [
			{ title: "Read the board", detail: "Find the line that is one move from completion or needs protection." },
			{ title: "Choose privately", detail: "Every participant locks one board position at the same time." },
			{ title: "Reveal and score", detail: "The strongest predefined move earns 1,000 points." },
		],
		exampleSummary: "One empty cell completes the top row for X.",
		exampleSteps: ["The board shows X X empty across the top row.", "Hana locks TOP RIGHT.", "The revealed X completes the row and earns Hana 1,000 points."],
	},
	"dots-and-boxes": {
		hero: `${ASSET_ROOT}/dots-and-boxes/how-to.webp`,
		example: `${ASSET_ROOT}/dots-and-boxes/example-round.webp`,
		exampleAlt: "Worked Dots and Boxes round: Hana chooses the missing right edge, completes the highlighted square, and earns 1,000 points.",
		summary: "Everyone inspects the same board and privately chooses the edge that claims or protects the highlighted box.",
		steps: [
			{ title: "Inspect boxes", detail: "Look for the highlighted square and count its existing edges." },
			{ title: "Choose one line", detail: "Lock the missing or strategically strongest edge." },
			{ title: "Reveal territory", detail: "The correct edge completes the box and earns 1,000 points." },
		],
		exampleSummary: "The highlighted box already has its top, left, and bottom edges.",
		exampleSteps: ["Hana sees that the right edge is missing.", "She locks RIGHT EDGE privately.", "The line closes the box and earns Hana 1,000 points."],
	},
	"hidden-picture": {
		hero: `${ASSET_ROOT}/hidden-picture/how-to.webp`,
		example: `${ASSET_ROOT}/hidden-picture/example-round.webp`,
		exampleAlt: "Worked Hidden Picture round: Hana matches row clue 3 with three consecutive filled cells and earns 1,000 points when the correct row pattern is revealed.",
		summary: "Use a compact row clue to choose the one cell pattern that satisfies it.",
		steps: [
			{ title: "Read the clue", detail: "The number describes consecutive filled cells in the highlighted line." },
			{ title: "Choose a pattern", detail: "Lock the candidate cell pattern that satisfies the clue." },
			{ title: "Reveal pattern", detail: "The correct cell pattern is shown and earns 1,000 points." },
		],
		exampleSummary: "A clue of 3 requires one uninterrupted group of three filled cells.",
		exampleSteps: ["The highlighted row has clue 3.", "Hana chooses the pattern with three consecutive cells.", "The correct row pattern is revealed and awards 1,000 points."],
	},
	"path-weaver": {
		hero: `${ASSET_ROOT}/path-weaver/how-to.webp`,
		example: `${ASSET_ROOT}/path-weaver/example-round.webp`,
		exampleAlt: "Worked Path Weaver round: Hana turns right around a blocked cell, keeps the route legal, reaches the exit, and earns 1,000 points.",
		summary: "Read the stated route constraints, privately choose the next valid action, and reveal whether it is legal.",
		steps: [
			{ title: "Inspect the route", detail: "Check the destination and the allowed, blocked, or already visited directions." },
			{ title: "Choose the next turn", detail: "Lock the segment that continues without breaking the route rules." },
			{ title: "Reveal the path", detail: "A legal predefined move earns 1,000 points." },
		],
		exampleSummary: "A blocked cell makes continuing straight illegal.",
		exampleSteps: ["Hana's route approaches an obstacle.", "She locks RIGHT from the four available actions.", "The revealed turn reaches the exit and earns 1,000 points."],
	},
	"quilt-puzzle": {
		hero: `${ASSET_ROOT}/quilt-puzzle/how-to.webp`,
		example: `${ASSET_ROOT}/quilt-puzzle/example-round.webp`,
		exampleAlt: "Worked Quilt Puzzle round: Hana completes the alternating circle-square pattern with Circle and earns 1,000 points.",
		summary: "Study a visual sequence and choose the patch or shape that completes its pattern.",
		steps: [
			{ title: "Study the pattern", detail: "Compare the repeated shapes, colours, and positions." },
			{ title: "Choose a patch", detail: "Lock the candidate that satisfies the visible rule." },
			{ title: "Reveal the design", detail: "The correct patch completes the grid and earns 1,000 points." },
		],
		exampleSummary: "The sequence alternates circle and square.",
		exampleSteps: ["The row reads circle, square, circle, square, blank.", "Hana selects CIRCLE.", "The completed alternating pattern earns her 1,000 points."],
	},
	"group-sudoku": {
		hero: `${ASSET_ROOT}/group-sudoku/how-to.webp`,
		example: `${ASSET_ROOT}/group-sudoku/example-round.webp`,
		exampleAlt: "Worked Group Sudoku round: Hana identifies 3 as the missing value in a 4x4 grid and earns 1,000 points.",
		summary: "Everyone simultaneously checks the highlighted row, column, and region and privately chooses the missing symbol.",
		steps: [
			{ title: "Check the grid", detail: "Inspect the highlighted row, column, and region together." },
			{ title: "Choose a symbol", detail: "Lock the one value that does not repeat in any group." },
			{ title: "Reveal the solution", detail: "The valid missing symbol earns 1,000 points." },
		],
		exampleSummary: "In a 4x4 grid, the highlighted row needs the only unused value.",
		exampleSteps: ["The row reads 1, 2, blank, 4.", "Hana chooses 3 after checking the column and region.", "The reveal places 3 and awards Hana 1,000 points."],
	},
	"signal-spectrum": {

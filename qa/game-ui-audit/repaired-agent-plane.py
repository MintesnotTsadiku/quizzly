...
r = browser.browser_start_session(
	...
	artifact_root="/tmp/gp-ui-repaired-agent-plane",
	timeout_ms=20000,
...
try:
	for action in [
		...
		{"action": "wait_for", "selector": ".puzzle-room"},
		{"action":"click", "selector":"[data-edge='h:0:0']"},
		{"action": "screenshot", "name": "dots-and-boxes-guide.png", "full_page": True},
		{"action": "open_url", "url": "/play/games/group-sudoku?lang=am", "wait_until": "domcontentloaded"},
		{"action": "wait_for", "selector": ".puzzle-room"},
		{"action":"click", "selector":"[data-cell='1']"},
